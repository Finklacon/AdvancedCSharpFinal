        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Golfer>().HasData(
                    new Golfer { FirstName = "Justin", LastName = "Fink", Age = 29, Email = "dakrlonz@hotmail.com", Gender = "Male", Handicap = 18.8, MemberID = 1, Username = "Finklacon", Password = "123" },
                     ...
                     new Golfer { FirstName = "Alexis", LastName = "Castille", Age = 31, Email = "@.com", Gender = "Female", Handicap = 25.8, MemberID = 6, Username = "Castille", Password = "123" },
                     new Golfer { FirstName = "Kim", LastName = "Wildestorm", Age = 30, Email = "@.com", Gender = "Female", Handicap = 1.8, MemberID = 7, Username = "Wildestorm", Password = "123" }
            );
